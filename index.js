(() => {
  ...
  var vh = function(i2) {
    return new BasicSize(append3(value2(i2))(fromString3("vh")));
  };
  ...
  var apply3 = /* @__PURE__ */ apply(/* @__PURE__ */ applyWriterT(semigroupArray)(applyIdentity));
  ...
  var maxHeight = /* @__PURE__ */ key2(/* @__PURE__ */ fromString4("max-height"));
  ...
  var key3 = /* @__PURE__ */ key(valOverflow);
  var overflowAuto = /* @__PURE__ */ fromString5("auto");
  var overflow = /* @__PURE__ */ key3(/* @__PURE__ */ fromString12("overflow"));

  // output/CSS.Text.Whitespace/index.js
  var fromString6 = /* @__PURE__ */ fromString(isStringValue);
  var whitespacePreWrap = /* @__PURE__ */ fromString6("pre-wrap");
  ...
  var append13 = /* @__PURE__ */ append(semigroupList2);
  var uncons3 = function(xs) {
    var v = step(xs);
    if (v instanceof Nil2) {
      return Nothing.value;
    }
  ...
  var take4 = function(n) {
    ...
    var $333 = map8(go2(n));
    return function($334) {
      return List($333(unwrap5($334)));
    };
  };
  var tail2 = function(xs) {
            ...
            switch (head5.tag) {
              ...
              case APPLY:
                ...
                if (fail) {
                  ...
                  tmp = true;
                  kid = killId++;
                  kills[kid] = kill2(early, fail === lhs ? head5._2 : head5._1, function() {
                    return function() {
                      delete kills[kid];
                      if (tmp) {
                        tmp = false;
  ...
  var randomRange = function(min6) {
    return function(max6) {
      return function __do2() {
        var n = random();
        return n * (max6 - min6) + min6;
      };
    };
  };
        ...
        return function(label6) {
          return function(p2) {
            return function(component2) {
              return function(input2) {
                return widget(new ComponentSlot(componentSlot22(label6)(p2)(component2)(input2)($$const(Nothing.value))));
              };
            };
          };
        };
  ...
  var style2 = /* @__PURE__ */ function() {
    ...
    var rules = function(rs) {
      var properties = bind5(mapMaybe(property)(rs))(function($16) {
  ...
  // output/Halogen.Typewriter.Lens/index.js
  ...
  var typeDelay = /* @__PURE__ */ function() {
    return prop3({
      reflectSymbol: function() {
        return "typeDelay";
      }
  ...
  var outputText = /* @__PURE__ */ function() {
    return prop3({
      reflectSymbol: function() {
        return "outputText";
      }
  ...
  var deleteDelay = /* @__PURE__ */ function() {
    return prop3({
      reflectSymbol: function() {
        return "deleteDelay";
      }
  ...
  var cursorHidden = /* @__PURE__ */ function() {
    return prop3({
      reflectSymbol: function() {
        return "cursorHidden";
      }
  ...
  var cursorDelay = /* @__PURE__ */ function() {
    return prop3({
      reflectSymbol: function() {
        return "cursorDelay";
      }
  ...
  var cursorHidden2 = /* @__PURE__ */ cursorHidden(strongFn);
  ...
  var appendModifying2 = /* @__PURE__ */ appendModifying(monadStateHalogenM)(semigroupString);
  var outputText2 = /* @__PURE__ */ outputText(strongFn);
  var assign3 = /* @__PURE__ */ assign2(monadStateHalogenM);
  var mode2 = /* @__PURE__ */ mode(strongFn);
  var deleteDelay2 = /* @__PURE__ */ deleteDelay(strongForget);
  var Finished = /* @__PURE__ */ function() {
    function Finished2() {
    }
    ;
    Finished2.value = new Finished2();
    return Finished2;
  }();
  var Typing = /* @__PURE__ */ function() {
    ...
    ;
    Typing2.value = new Typing2();
    return Typing2;
  }();
  var Deleting = /* @__PURE__ */ function() {
    function Deleting2() {
    }
    ;
    Deleting2.value = new Deleting2();
    return Deleting2;
  }();
  ...
  var UpdateState = /* @__PURE__ */ function() {
    ...
    ;
    UpdateState2.value = new UpdateState2();
    return UpdateState2;
  }();
  var UpdateCursor = /* @__PURE__ */ function() {
    function UpdateCursor2() {
    }
    ;
    UpdateCursor2.value = new UpdateCursor2();
    return UpdateCursor2;
  }();
  var eqMode = {
    eq: function(x) {
      return function(y) {
        ...
        ;
        if (x instanceof Deleting && y instanceof Deleting) {
          return true;
        }
        ;
        return false;
  ...
  var typewriter = function(dictMonadAff) {
    ...
    var sleepWith = function(modifyDelay) {
      return function(field) {
        return bindFlipped5(function() {
          var $75 = view(field);
          return function($76) {
            return liftAff2(delay(Milliseconds(modifyDelay(unwrap8($75($76))))));
          };
        }())(get3);
      };
    };
    var sleep = sleepWith(identity9);
    ...
    var initialState = function(input2) {
      return {
        words: function() {
          if (input2.initialMode instanceof Typing) {
            return input2.words;
          }
          ;
          if (input2.initialMode instanceof Deleting) {
            return fold22(tail2(input2.words));
          }
          ;
          throw new Error("Failed pattern match at Halogen.Typewriter (line 128, column 14 - line 130, column 44): " + [input2.initialMode.constructor.name]);
        }(),
        outputText: function() {
          if (input2.initialMode instanceof Typing) {
            return mempty2;
          ...
          ;
          if (input2.initialMode instanceof Deleting) {
            return fold12(head3(input2.words));
          }
          ;
          throw new Error("Failed pattern match at Halogen.Typewriter (line 131, column 19 - line 133, column 44): " + [input2.initialMode.constructor.name]);
        }(),
        typeDelay: input2.typeDelay,
        deleteDelay: input2.deleteDelay,
        pauseDelay: input2.pauseDelay,
        cursorDelay: input2.cursorDelay,
        mode: Typing.value,
        cursor: input2.cursor,
        cursorHidden: true,
        jitter: input2.jitter,
        running: true,
        initialMode: input2.initialMode
      };
    };
    var handleAction = function(v) {
      if (v instanceof Initialize2) {
        return bind6(liftEffect12(create3))(function(v1) {
          var forkDispatch = function() {
            var $77 = notify(v1.listener);
            return function($78) {
              return $$void6(liftAff2(forkAff(liftEffect4($77($78)))));
            };
          }();
      ...
      if (v instanceof UpdateCursor) {
        return bind6(get3)(function(state3) {
          return when1(state3.running)(discard3(when1(eq2(state3.mode)(Typing.value))(modifying2(cursorHidden2)(not2)))(function() {
            return discard3(sleep(cursorDelay2))(function() {
              return handleAction(UpdateCursor.value);
            });
          }));
        });
      }
      ...
      if (v instanceof UpdateState) {
        return bind6(get3)(function(state3) {
          ...
          if (v1 instanceof Nothing) {
            return discard3($$void6(modify5(function(v2) {
              var $64 = {};
              for (var $65 in v2) {
          ...
          if (v1 instanceof Just) {
            return discard3(function() {
              if (state3.mode instanceof Typing) {
                ...
                if (v2 instanceof Nothing) {
                  return discard3(modifying2(words2)(function($79) {
                    return fold22(tail2($79));
                  }))(function() {
                    return discard3(sleep(pauseDelay2))(function() {
                      return $$void6(modify5(function(v3) {
                        var $69 = {};
                        for (var $70 in v3) {
                        ...
                        ;
                        $69.mode = Deleting.value;
                        $69.cursorHidden = false;
                        return $69;
                      }));
                    });
                  });
                ...
                if (v2 instanceof Just) {
                  return bind6(liftEffect12(state3.jitter))(function(coefficient) {
                    return discard3(sleepWith(function(v3) {
                ...
                ;
                throw new Error("Failed pattern match at Halogen.Typewriter (line 188, column 15 - line 198, column 50): " + [v2.constructor.name]);
              }
              ;
              if (state3.mode instanceof Deleting) {
                var $73 = $$null2(state3.outputText);
                if ($73) {
                  return assign3(mode2)(Typing.value);
                }
                ;
                return discard3(sleep(deleteDelay2))(function() {
                  return modifying2(outputText2)(take3(length3(state3.outputText) - 1 | 0));
                });
              }
              ;
              throw new Error("Failed pattern match at Halogen.Typewriter (line 185, column 11 - line 206, column 65): " + [state3.mode.constructor.name]);
            }())(function() {
              return handleAction(UpdateState.value);
            });
          }
          ;
          throw new Error("Failed pattern match at Halogen.Typewriter (line 180, column 7 - line 207, column 35): " + [v1.constructor.name]);
        });
      }
      ;
      throw new Error("Failed pattern match at Halogen.Typewriter (line 166, column 18 - line 207, column 35): " + [v.constructor.name]);
    };
    var $$eval = mkEval({
      handleAction,
  ...
  var normalize2 = function(str) {
    return function(lines) {
      var blankLineRemoved = function(v) {
        var $42 = countPrefix(eq12(" "))(v.last) === length4(v.last);
        if ($42) {
          var $43 = $$null(v.init);
          if ($43) {
            return [""];
      ...
      var minSpaces = foldl3(function(acc) {
      ...
      return function(v) {
        var $53 = length2(lines) === length(blankLineRemoved);
        if ($53) {
          return v.value0;
        }
        ;
  ...
  var component = function(dictMonadAff) {
    ...
    var subtitle = {
      ...
      initialMode: defaultTypewriter.initialMode,
      jitter: defaultTypewriter.jitter,
      pauseDelay: defaultTypewriter.pauseDelay
    };
    var handleAction = function(v) {
      return liftEffect8(highlightAll);
    };
    var example = function(template) {
      return div3([css("container pb-5")])([h3([css("has-text-weight-semibold is-size-4")])([text5(template.title)]), p_([template.description]), div3([css("container pb-2 is-flex is-align-items-center")])(function() {
        ...
        ;
        throw new Error("Failed pattern match at Main (line 294, column 11 - line 301, column 26): " + [template.typewriter.constructor.name]);
    ...
    var deletingExample = function() {
      ...
      return example({
        ...
        description: text5(intercalate3(" ")(["Instead of typing the initial word, you can have the typewriter delete it instead.", "If you don't notice a difference, refresh your page and look at the example again."])),
        code: normalize2('\n            defaultTypewriter\n              { words = repeat "Wisdom is the offspring of suffering and time."\n              , initialMode = Deleting\n              }\n            '),
        typewriter: new Just(typewriterHtml(input2))
      });
    }();
    var bold = function() {
      var $36 = span4([css("has-text-weight-bold")]);
      return function($37) {
        return $36(singleton2(text5($37)));
      };
    }();
    var finiteRunsExample = function() {
      var input2 = {
        words: replicate2(2)("I will only type this sentence twice."),
        cursor: defaultTypewriter.cursor,
        cursorDelay: defaultTypewriter.cursorDelay,
        deleteDelay: defaultTypewriter.deleteDelay,
        initialMode: defaultTypewriter.initialMode,
    ...
    var multipleWordsExample = function() {
      var input2 = {
        words: cycle(fromFoldable6(map25(function(v1) {
          return v1 + ".";
        })(["John", "Olivia", "Liam", "Emma", "Noah", "Charlotte", "Oliver", "Amelia"]))),
        cursor: defaultTypewriter.cursor,
        cursorDelay: defaultTypewriter.cursorDelay,
        deleteDelay: defaultTypewriter.deleteDelay,
        initialMode: defaultTypewriter.initialMode,
  ...
  var main2 = /* @__PURE__ */ runHalogenAff(/* @__PURE__ */ bindFlipped(bindAff)(/* @__PURE__ */ runUI2(/* @__PURE__ */ component(monadAffAff))(unit))(awaitBody));
